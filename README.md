...
| **elfldr** | `v0.25` | `—` | No description provided. | `2026-08-22` | [Source](https://github.com/ps5-payload-dev/elfldr/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/elfldr-ps5_v0.25.elf) |
...
| **ftpsrv** | `v0.21.1` | `—` | No description provided. | `2026-08-20` | [Source](https://github.com/ps5-payload-dev/ftpsrv/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/ftpsrv-ps5_v0.21.1.elf) |
...
| **Payload Manager X** | `v0.5.1.6x` | `—` | No description provided. | `2026-08-25` | [Source](https://github.com/bsk193/ps5-payload-manager-x/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/pldmgrx_v0.5.1.6x.elf) |
...
| **PIZZA-HEN** | `v2.00` | `—` | All-in-one PS5 homebrew environment with KStuff, FTP, ps5debug-NG, plugin manager, and Itemzflow integration. | `2026-08-24` | [Source](https://github.com/Michele-M-Media/PIZZA-HEN/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/PIZZA-HEN-v2.00.elf) |
...
| **PS5GameCompressor** | `v1.0.4` | `—` | No description provided. | `2026-08-21` | [Source](https://github.com/juma-sayeh/PS5-Game-Compressor/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/game-compressor_v1.0.4.elf) |
| **PS5Upload** | `v5.4.19` | `—` | No description provided. | `2026-08-24` | [Source](https://github.com/phantomptr/ps5upload/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/ps5upload-5.4.19.elf) |
...
| **WebKit Autoloader** | `v0.4.0` | `—` | PS5 WebKit exploit autoloader installer ELF by itsPLK. | `2026-08-24` | [Source](https://github.com/itsPLK/ps5-webkit-autoloader/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/webkit-autoloader-installer_v0.4.0.elf) |
| **WebKit Autoloader X** | `v0.4.0.3x` | `—` | PS5 WebKit exploit autoloader X installer ELF by bsk193. | `2026-08-24` | [Source](https://github.com/bsk193/ps5-webkit-autoloader-x/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/webkit-autoloader-x-installer_v0.4.0.3x.elf) |
