...
| **Payload Manager X** | `v0.5.1.7x` | `—` | No description provided. | `2026-08-25` | [Source](https://github.com/bsk193/ps5-payload-manager-x/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/pldmgrx_v0.5.1.7x.elf) |
