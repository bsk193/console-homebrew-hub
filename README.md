...
| **CHH Local Installer** | `v1.0.0` | `—` | Console Homebrew Hub local installer — installs PS5 homescreen shortcuts pointing to your local CHH host (192.168.1.139:6969). | `2026-08-18` | [Source](#) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/chh-local-installer_v1.0.0.elf) |
...
| **PS5Upload** | `v5.2.1` | `—` | No description provided. | `2026-08-12` | [Source](https://github.com/phantomptr/ps5upload/releases) | [Download](https://github.com/bsk193/console-homebrew-hub/releases/latest/download/ps5upload-5.2.1.elf) |
